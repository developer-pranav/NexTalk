...
export default function MobileHomeHeader({ unreadTotal, query, onQueryChange }) {
    ...
    <div className="px-4 pt-5 pb-3">
      <div className="flex items-start justify-between">
        ...
        <div className="flex items-center gap-2">
          ...
          <button
            className="grid h-10 w-10 place-items-center rounded-2xl transition-transform active:scale-90"
